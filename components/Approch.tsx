  ...
  return (
    <section className="w-full py-20">
      <h1 className="heading">
       Ready to showcase your work with a {' '} <span className="text-purple"> custom online portfolio </span> 
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        ...
        description="This is where the magic happens! Based on the approved design, I'll translate everything into funtional code, building your website from the ground up.">
          <CanvasRevealEffect
            animationSpeed={3}
...
const Card = ({
  ...
  return (
    <div
      ...
      className="border border-black/[0.2] group/canvas-card flex items-center justify-center dark:border-white/[0.2]  max-w-sm w-full mx-auto p-4 rounded-3xl relative lg:h-[35rem]"
    >
